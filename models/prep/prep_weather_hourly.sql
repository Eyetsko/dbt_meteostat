...
add_features AS (
    SELECT *
		...
		, TRIM(TO_CHAR(timestamp, 'HH24:MI:SS')) AS time                           -- only time (hours:minutes:seconds) as TIME data type
...
add_more_features AS (
    SELECT *
		,(CASE 
			WHEN time BETWEEN '20:00:00' AND '23:59:59'THEN 'night'
			WHEN time BETWEEN '00:00:00' AND '05:59:00'THEN 'night'
			WHEN time BETWEEN '06:00:00' AND '17:59:00' THEN 'day'
			WHEN time BETWEEN '18:00:00' AND '19:59:00' THEN 'evening'
		END) AS day_part
    FROM add_features
)
SELECT *
